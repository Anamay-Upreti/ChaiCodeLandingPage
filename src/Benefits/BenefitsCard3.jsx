...
const BenefitsCard = () => {
  return (
    <>
      <div className="w-96 h-60 bg-gradient-to-t from-[#E16B00] to-[#2C140193] rounded-3xl absolute top-1110 left-257 transition-all duration-1000 hover:shadow-[0_0_15px_5px_rgba(255,248,121,0.8)_inset] max-sm:hidden">
        ...
        <div className="text-white jaldi-bold absolute top-34 left-6 text-xl">
          <h1>There is nothing like late night discussions</h1>
          <h1>with fellow learners and solving bugs.</h1>
        </div>
      </div>

      {/* mobile  */}

      <div className="w-38 h-26 bg-gradient-to-t from-[#E16B00] to-[#2C140193] rounded-2xl absolute top-970 left-22 transition-all duration-1000 hover:shadow-[0_0_15px_5px_rgba(255,248,121,0.8)_inset] sm:hidden">
