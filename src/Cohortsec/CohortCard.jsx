...
const CohortCard = () => {
  return (
    <>
      <div className="w-86 h-[450px] rounded-3xl absolute top-490 left-65 bg-[#0F0655A6] transition-all duration-1000 hover:shadow-[0_0_15px_5px_rgba(254,147,50,0.7)_inset] max-sm:hidden">
        <iframe
          className="absolute top-3 left-8 rounded-2xl cursor-pointer "
          width="280"
          height="205"
          src="https://www.youtube.com/embed/yG8JMlldoCE?si=42ZIVQCe2IzPpZXG" // Replace with your YouTube video ID
      ...
      {/* mobile */}
      <div className="w-86 h-[450px] rounded-3xl absolute top-280 left-18 bg-[#0F0655A6] transition-all duration-1000 hover:shadow-[0_0_15px_5px_rgba(254,147,50,0.7)_inset] sm:hidden">
        <iframe
          className="absolute top-3 left-8 rounded-2xl cursor-pointer "
          width="280"
          height="205"
